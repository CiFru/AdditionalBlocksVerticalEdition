...
public class VerticalBlockType {
    ...
    public static final VerticalBlockType SMOOTH_STONE = createBlockType("smooth_stone", "Smooth Stone", () -> Blocks.SMOOTH_STONE_SLAB, () -> Blocks.SMOOTH_STONE, () -> Blocks.SMOOTH_STONE, true, new ResourceLocation("minecraft", "block/smooth_stone"));
    ...
    public static final VerticalBlockType MARBLE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "marble_brick", "Marble Brick", "marble_brick_slab", "marble_brick_stairs", "marble_bricks", true, new ResourceLocation("abstoneedition", "marble_bricks"));
    ...
    public static final VerticalBlockType BLACK_MARBLE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "black_marble_brick", "Black Marble Brick", "black_marble_brick_slab", "black_marble_brick_stairs", "black_marble_bricks", true, new ResourceLocation("abstoneedition", "black_marble_bricks"));
    ...
    public static final VerticalBlockType BLOODSTONE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "bloodstone_brick", "Bloodstone Brick", "bloodstone_brick_slab", "bloodstone_brick_stairs", "bloodstone_bricks", true, new ResourceLocation("abstoneedition", "bloodstone_bricks"));
    ...
    public static final VerticalBlockType LIMESTONE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "limestone_brick", "Limestone Brick", "limestone_brick_slab", "limestone_brick_stairs", "limestone_bricks", true, new ResourceLocation("abstoneedition", "limestone_bricks"));
    ...
    public static final VerticalBlockType VOLCANIC_STONE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "volcanic_stone_brick", "Volcanic Stone Brick", "volcanic_stone_brick_slab", "volcanic_stone_brick_stairs", "volcanic_stone_bricks", true, new ResourceLocation("abstoneedition", "volcanic_stone_bricks"));

    //ADG+ bricks
    public static final VerticalBlockType ANDESITE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "andesite_brick", "Andesite Brick", "andesite_brick_slab", "andesite_brick_stairs", "andesite_bricks", true, new ResourceLocation("abstoneedition", "andesite_bricks"));
    public static final VerticalBlockType DIORITE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "diorite_brick", "Diorite Brick", "diorite_brick_slab", "diorite_brick_stairs", "diorite_bricks", true, new ResourceLocation("abstoneedition", "diorite_bricks"));
    public static final VerticalBlockType GRANITE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "granite_brick", "Granite Brick", "granite_brick_slab", "granite_brick_stairs", "granite_bricks", true, new ResourceLocation("abstoneedition", "granite_bricks"));
    public static final VerticalBlockType BROWN_BRICKS = createBlockTypeForOtherMod("abstoneedition", "brown_brick", "Brown Brick", "brown_brick_slab", "brown_brick_stairs", "brown_bricks", true, new ResourceLocation("abstoneedition", "brown_bricks"));
    public static final VerticalBlockType GRAY_BRICKS = createBlockTypeForOtherMod("abstoneedition", "gray_brick", "Gray Brick", "gray_brick_slab", "gray_brick_stairs", "gray_bricks", true, new ResourceLocation("abstoneedition", "gray_bricks"));
    ...
    public static final VerticalBlockType GLOWSTONE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "glowstone_brick", "Glowstone Brick", "glowstone_brick_slab", "glowstone_brick_stairs", "glowstone_bricks", true, new ResourceLocation("abstoneedition", "glowstone_bricks"));
    ...
    //less important stones
    public static final VerticalBlockType SMOOTH_STONE_BRICKS = createBlockTypeForOtherMod("abstoneedition", "smooth_stone_brick", "Smooth Stone Brick", "smooth_stone_brick_slab", "smooth_stone_brick_stairs", "smooth_stone_bricks", true, new ResourceLocation("abstoneedition", "smooth_stone_bricks"));
