...
//    public static final VerticalBlockType MUD_BRICK = createBlockType("mud_brick", "Mud Brick", () -> Blocks.MUD_BRICK_SLAB, () -> Blocks.MUD_BRICK_STAIRS, () -> Blocks.MUD_BRICKS, true, new ResourceLocation("minecraft", "block/mud_bricks"));
    ...
    public static final VerticalBlockType WHITE_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "white_concrete", "White Concrete", "white_concrete_slab", "white_concrete_stairs", "minecraft:white_concrete", true, new ResourceLocation("minecraft", "block/white_concrete"));
    public static final VerticalBlockType BLACK_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "black_concrete", "Black Concrete", "black_concrete_slab", "black_concrete_stairs", "minecraft:black_concrete", true, new ResourceLocation("minecraft", "block/black_concrete"));
    public static final VerticalBlockType GRAY_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "gray_concrete", "Gray Concrete", "gray_concrete_slab", "gray_concrete_stairs", "minecraft:gray_concrete", true, new ResourceLocation("minecraft", "block/gray_concrete"));
    public static final VerticalBlockType LIGHT_GRAY_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "light_gray_concrete", "Light Gray Concrete", "light_gray_concrete_slab", "light_gray_concrete_stairs", "minecraft:light_gray_concrete", true, new ResourceLocation("minecraft", "block/light_gray_concrete"));
    public static final VerticalBlockType PINK_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "pink_concrete", "Pink Concrete", "pink_concrete_slab", "pink_concrete_stairs", "minecraft:pink_concrete", true, new ResourceLocation("minecraft", "block/pink_concrete"));
    public static final VerticalBlockType BROWN_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "brown_concrete", "Brown Concrete", "brown_concrete_slab", "brown_concrete_stairs", "minecraft:brown_concrete", true, new ResourceLocation("minecraft", "block/brown_concrete"));
    public static final VerticalBlockType RED_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "red_concrete", "Red Concrete", "red_concrete_slab", "red_concrete_stairs", "minecraft:red_concrete", true, new ResourceLocation("minecraft", "block/red_concrete"));
    public static final VerticalBlockType ORANGE_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "orange_concrete", "Orange Concrete", "orange_concrete_slab", "orange_concrete_stairs", "minecraft:orange_concrete", true, new ResourceLocation("minecraft", "block/orange_concrete"));
    public static final VerticalBlockType YELLOW_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "yellow_concrete", "Yellow Concrete", "yellow_concrete_slab", "yellow_concrete_stairs", "minecraft:yellow_concrete", true, new ResourceLocation("minecraft", "block/yellow_concrete"));
    public static final VerticalBlockType LIME_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "lime_concrete", "Lime Concrete", "lime_concrete_slab", "lime_concrete_stairs", "minecraft:lime_concrete", true, new ResourceLocation("minecraft", "block/lime_concrete"));
    public static final VerticalBlockType GREEN_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "green_concrete", "Green Concrete", "green_concrete_slab", "green_concrete_stairs", "minecraft:green_concrete", true, new ResourceLocation("minecraft", "block/green_concrete"));
    public static final VerticalBlockType CYAN_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "cyan_concrete", "Cyan Concrete", "cyan_concrete_slab", "cyan_concrete_stairs", "minecraft:cyan_concrete", true, new ResourceLocation("minecraft", "block/cyan_concrete"));
    public static final VerticalBlockType LIGHT_BLUE_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "light_blue_concrete", "Light Blue Concrete", "light_blue_concrete_slab", "light_blue_concrete_stairs", "minecraft:light_blue_concrete", true, new ResourceLocation("minecraft", "block/light_blue_concrete"));
    public static final VerticalBlockType BLUE_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "blue_concrete", "Blue Concrete", "blue_concrete_slab", "blue_concrete_stairs", "minecraft:blue_concrete", true, new ResourceLocation("minecraft", "block/blue_concrete"));
    public static final VerticalBlockType PURPLE_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "purple_concrete", "Purple Concrete", "purple_concrete_slab", "purple_concrete_stairs", "minecraft:purple_concrete", true, new ResourceLocation("minecraft", "block/purple_concrete"));
    public static final VerticalBlockType MAGENTA_CONCRETE = createBlockTypeForOtherMod("abstoneedition", "magenta_concrete", "Magenta Concrete", "magenta_concrete_slab", "magenta_concrete_stairs", "minecraft:magenta_concrete", true, new ResourceLocation("minecraft", "block/magenta_concrete"));

    public static final VerticalBlockType WHITE_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "white_terracotta", "White Terracotta", "white_terracotta_slab", "white_terracotta_stairs", "minecraft:white_terracotta", true, new ResourceLocation("minecraft", "block/white_terracotta"));
    public static final VerticalBlockType BLACK_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "black_terracotta", "Black Terracotta", "black_terracotta_slab", "black_terracotta_stairs", "minecraft:black_terracotta", true, new ResourceLocation("minecraft", "block/black_terracotta"));
    public static final VerticalBlockType GRAY_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "gray_terracotta", "Gray Terracotta", "gray_terracotta_slab", "gray_terracotta_stairs", "minecraft:gray_terracotta", true, new ResourceLocation("minecraft", "block/gray_terracotta"));
    public static final VerticalBlockType LIGHT_GRAY_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "light_gray_terracotta", "Light Gray Terracotta", "light_gray_terracotta_slab", "light_gray_terracotta_stairs", "minecraft:light_gray_terracotta", true, new ResourceLocation("minecraft", "block/light_gray_terracotta"));
    public static final VerticalBlockType PINK_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "pink_terracotta", "Pink Terracotta", "pink_terracotta_slab", "pink_terracotta_stairs", "minecraft:pink_terracotta", true, new ResourceLocation("minecraft", "block/pink_terracotta"));
    public static final VerticalBlockType BROWN_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "brown_terracotta", "Brown Terracotta", "brown_terracotta_slab", "brown_terracotta_stairs", "minecraft:brown_terracotta", true, new ResourceLocation("minecraft", "block/brown_terracotta"));
    public static final VerticalBlockType RED_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "red_terracotta", "Red Terracotta", "red_terracotta_slab", "red_terracotta_stairs", "minecraft:red_terracotta", true, new ResourceLocation("minecraft", "block/red_terracotta"));
    public static final VerticalBlockType ORANGE_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "orange_terracotta", "Orange Terracotta", "orange_terracotta_slab", "orange_terracotta_stairs", "minecraft:orange_terracotta", true, new ResourceLocation("minecraft", "block/orange_terracotta"));
    public static final VerticalBlockType YELLOW_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "yellow_terracotta", "Yellow Terracotta", "yellow_terracotta_slab", "yellow_terracotta_stairs", "minecraft:yellow_terracotta", true, new ResourceLocation("minecraft", "block/yellow_terracotta"));
    public static final VerticalBlockType LIME_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "lime_terracotta", "Lime Terracotta", "lime_terracotta_slab", "lime_terracotta_stairs", "minecraft:lime_terracotta", true, new ResourceLocation("minecraft", "block/lime_terracotta"));
    public static final VerticalBlockType GREEN_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "green_terracotta", "Green Terracotta", "green_terracotta_slab", "green_terracotta_stairs", "minecraft:green_terracotta", true, new ResourceLocation("minecraft", "block/green_terracotta"));
    public static final VerticalBlockType CYAN_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "cyan_terracotta", "Cyan Terracotta", "cyan_terracotta_slab", "cyan_terracotta_stairs", "minecraft:cyan_terracotta", true, new ResourceLocation("minecraft", "block/cyan_terracotta"));
    public static final VerticalBlockType LIGHT_BLUE_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "light_blue_terracotta", "Light Blue Terracotta", "light_blue_terracotta_slab", "light_blue_terracotta_stairs", "minecraft:light_blue_terracotta", true, new ResourceLocation("minecraft", "block/light_blue_terracotta"));
    public static final VerticalBlockType BLUE_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "blue_terracotta", "Blue Terracotta", "blue_terracotta_slab", "blue_terracotta_stairs", "minecraft:blue_terracotta", true, new ResourceLocation("minecraft", "block/blue_terracotta"));
    public static final VerticalBlockType PURPLE_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "purple_terracotta", "Purple Terracotta", "purple_terracotta_slab", "purple_terracotta_stairs", "minecraft:purple_terracotta", true, new ResourceLocation("minecraft", "block/purple_terracotta"));
    public static final VerticalBlockType MAGENTA_TERRACOTTA = createBlockTypeForOtherMod("abstoneedition", "magenta_terracotta", "Magenta Terracotta", "magenta_terracotta_slab", "magenta_terracotta_stairs", "minecraft:magenta_terracotta", true, new ResourceLocation("minecraft", "block/magenta_terracotta"));
